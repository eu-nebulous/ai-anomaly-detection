...
class MetricDiscovery:
    ...
    def get_allowed_metrics(self, instance, number_of_days_to_use_data_from):
        query_string = (
        ...
        logging.info(f"[MetricDiscovery] Querying InfluxDB to get allowed_metrics on the instance {instance} and the last {number_of_days_to_use_data_from} days:\n{query_string}")
